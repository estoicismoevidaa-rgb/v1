...
let SUPABASE_URL = (import.meta as any).env.VITE_SUPABASE_URL || 'https://qtcexymeadsenoycdvrk.supabase.co';
...
console.log('Memory Fruit initializing Supabase with endpoint:', SUPABASE_URL);
