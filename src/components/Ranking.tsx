...
export function Ranking({ ranking, globalRanking, loadingGlobal, onClear, onBack }: RankingProps) {
  ...
  const podium = globalRanking.slice(0, 3);
  const remaining = globalRanking.slice(3);
            ...
            >
              {loadingGlobal ? (
                      ...
                      <div className="order-2 md:order-1">
                        <div className="flex flex-col items-center">
                          ...
                          <div className="bg-slate-400/10 border border-slate-400/20 p-6 rounded-[2rem] w-full text-center">
                            ...
                            <p className="text-slate-400 font-black text-2xl">{podium[1].totalPoints}</p>
                      ...
                      <div className="order-1 md:order-2">
                        <div className="flex flex-col items-center">
                          ...
                          <div className="bg-yellow-400/10 border-2 border-yellow-400/30 p-8 rounded-[2.5rem] w-full text-center scale-110">
                            ...
                            <p className="text-yellow-400 font-black text-4xl">{podium[0].totalPoints}</p>
                      ...
                      <div className="order-3">
                        <div className="flex flex-col items-center">
                          ...
                          <div className="bg-orange-600/10 border border-orange-600/20 p-6 rounded-[2rem] w-full text-center">
                            ...
                            <p className="text-orange-600 font-black text-2xl">{podium[2].totalPoints}</p>
                        ...
                        {remaining.map((entry, i) => (
                          <div key={i} className="flex items-center justify-between p-5 hover:bg-blue-600/10 transition-colors">
                            ...
                            <div className="text-right">
                              <span className="font-black text-xl text-blue-200">{entry.totalPoints}</span>
                              <span className="block text-[8px] uppercase tracking-widest text-blue-500 font-bold">Total Pts</span>
                            </div>
                          </div>
                        ))}
                      </div>
                ...
                <div className="text-center py-24 bg-blue-950/20 rounded-[3rem] border-2 border-dashed border-blue-800">
                  ...
                  <p className="text-blue-500 text-sm">Seja o primeiro a jogar online e dominar o topo.</p>
                </div>
              )}
            </motion.div>
          ) : (
